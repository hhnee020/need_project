...
<script>
    function fn_popup1(){
        ...
        var url = "adminAccountSubmit.html";
        window.open(url,"adminAccountSubmit","width=400, height=200");
    }
    
    function fn_popup2(){
    
    var url = "adminAccountModify.html";
...
<section class="sec1">
    ...
    <table class="table1 clearfix">
        ...
        <caption class="caption1" ><h5 style="text-align: left;">관리자 계정 관리</h5></caption>
        ...
        <colgroup>
            ...
            <div class="btn1">
                ...
                <div class="btn0 btn1 btn2 ">
                    ...
                    onClick="fn_popup1(); return false;">등록</button>
                    <button class="btn  btn-primary" type="submit"
            ...
            <tr>
                ...
                <th class="td1">1</th>
                <th class="td1" ><a href="adminAccountSubmit.html" onClick="window.open(this.href, '', 'width=400, height=350'); return false;">아이디1</a>
                </th>
                
            <th class="td1"><a href="adminGrantSubmit.html" onClick="window.open(this.href, '', 'width=400, height=200'); return false;">관리자</a></th>
