    ...
    <section class="sec1">
        <table class="join_tb">
            ...
            <tr>
                ...
                <td class="info_td"><input type="text">
            ...
            <tr>
                ...
                <td class="info_td">
                    <input type="text" class="pbox"> - <input type="text"class="pbox"> - <input type="text"class="pbox"></td>
            </tr>        
            <tr>
            ...
            <tr style="height: 80px;">
                ...
                <td class="info_td">
                    <input type="text" class="adbox" style="width:60px">
                    <button>우편번호</button><br>
                    <input type="text" class="adbox"><br>
                    <input type="text" class="adbox">
                </td>
            </tr> 
            <tr>
