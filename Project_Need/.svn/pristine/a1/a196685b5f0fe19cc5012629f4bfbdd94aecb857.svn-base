        ...
        <div style="text-align: center; ">
            <div class="content_list_box" id="question_1">
                ...
                <table style="position: absolute; top: 25%; left: 14%;" id="list_table">
                    ...
                    <tr>
                        ...
                        <td class="view_td" id="question_list_view" onclick="location=''">문의 목록 보기</td>
                    </tr>
                </table>
            </div>
            <div class="content_list_box">
                ...
                <div style="position: absolute; top: 35%; left: 14%;">
                    <div style="display: inline-block;" class="at_question">답변 목록</div>
                    <div style="display: inline-block;" class="at_question">답변 작성</div>
                </div>
            </div>
        </div>
    </article>
