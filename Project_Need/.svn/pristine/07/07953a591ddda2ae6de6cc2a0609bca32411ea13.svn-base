            ...
            <article>
                <form>
                    <div style="margin-top: 22%;">
                        <input type="text" placeholder="ID" class="login_box" id="">
                        <div style="margin:0.5%"></div>
                        <input type="text" placeholder="PW" class="login_box">
                    </div>
                    <div style="margin:0.5%"></div>
                ...
                <div style="width: 350px;">
                    <ul id="login_ul" style="list-style: none; margin-top: 5%;">
                        <li>회원가입</li>
                        <li>아이디 찾기</li>
                        <li style="border-right: none;">비밀번호 찾기</li>
                    </ul>
                </div>
            </article>
            <article style="margin-top: 5%;">
                <div style="width: 25%; height: 50px; border-top: 1px solid #555; text-align: center; position: relative;">
                    ...
                    <ul id="outside_login" style="margin-top: 7%;">
                        <li> <a><img src="../src/kakaotalk.png"></a> </li>
                        <li> <a><img src="../src/facebook.png"></a> </li>
                        <li> <a><img src="../src/google.png"></a> </li>
                    </ul>
                </div>
            </article>
