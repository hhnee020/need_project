...
<body>
	...
	<div style = "width:700px; padding-left:70px; ">
			...
			<div style ="width:700px; text-align:left; margin-left:15px;">
				<button type ="button" class= "nav_button" onclick="location='adBoard2.jsp' ">게시판 관리</button>
				<button type ="button" class= "nav_button" onclick="location='adAll.jsp' ">통합 관리</button>
